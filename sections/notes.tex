...
\end{lemma}
\begin{proof}
    We first show that $\Phi(-z) \geq \frac{1}{2 \pi} \frac{z}{z^2 + 1} e^{-\frac{1}{2} z^2}$
    for all $z \geq 0$.
    In order to prove this lower bound, we define 
    $h(z) = \Phi(-z) - \frac{1}{2 \pi} \frac{z}{z^2 + 1} e^{-\frac{1}{2} z^2}$
    and show that $h(z)$ is positive for all $z \geq 0$.
    The derivative $h'(z) = -2 \frac{e^{-\frac{1}{2} z^2}}{(t^2 + 1)^2}$ is 
    ...
    In the next step, we prove that $e^{z^2} \cdot \Phi(-z) \geq 1$:
\end{proof}
